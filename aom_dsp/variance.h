...
typedef unsigned int (*aom_sad_fn_t)(const uint16_t *a, int a_stride,
                                     const uint16_t *b, int b_stride);

typedef unsigned int (*aom_sad_avg_fn_t)(const uint16_t *a, int a_stride,
                                         const uint16_t *b, int b_stride,
                                         const uint16_t *second_pred);

typedef void (*aom_copy32xn_fn_t)(const uint16_t *a, int a_stride, uint16_t *b,
                                  int b_stride, int n);

typedef void (*aom_sad_multi_d_fn_t)(const uint16_t *a, int a_stride,
                                     const uint16_t *const b_array[],
                                     int b_stride, unsigned int *sad_array);

typedef unsigned int (*aom_variance_fn_t)(const uint16_t *a, int a_stride,
                                          const uint16_t *b, int b_stride,
                                          unsigned int *sse);

typedef unsigned int (*aom_subpixvariance_fn_t)(const uint16_t *a, int a_stride,
...
typedef unsigned int (*aom_masked_sad_fn_t)(const uint16_t *src, int src_stride,
